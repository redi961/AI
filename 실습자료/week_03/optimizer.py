...
class HillClimbing(Setup) :
  def __init__(self) :
    Setup.__init__(self)
    self._pType = 0 # problem
    self._limitStuck = 100 # Max evalation
...
class FirstChoice(HillClimbing) :
  def displaySetting(self) :
    ...
    HillClimbing.displaySetting(self)
    print("Max ecaluations with no improvement : {0:,} iterations".format(self._limitStuck))
...
class GradientDescent(HillClimbing) :
  def displaySetting(self):
    ...
    print("Increment for calculating derivatives")
